...
def index():
    ...
    return (
        ...
        "<h1>Google OAuth</h1>"
        "<p>People API Birthday &amp; Gender Leak PoC</p>"
        f"<a class='btn btn-google' href='/login'>{GOOGLE_SVG} Sign in with Google</a>"
        "<div style='color:#64748b;font-size:.78rem;margin:6px 0 16px'>Basic scopes only — leaks public birthday/gender without consent</div>"
